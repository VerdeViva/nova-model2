...
const examples = [
  ...
  "How far along is the QA?",
  "Are there any blockers regarding our roll-out date?",
];
      ...
      {messages.length > 0 ? (
        messages.map((message, i) => (
          <div
            key={i}
            className={clsx(
              "flex w-full items-center justify-center border-b border-blue-200 py-8",
              message.role === "user" ? "bg-white" : "bg-blue-100",
            )}
          >
        ...
        <div className="border-gray-200sm:mx-0 mx-5 mt-20 max-w-screen-md rounded-md border sm:w-full">
          <div className="flex flex-col space-y-4 p-7 sm:p-10">
            ...
            <h1 className="text-lg font-semibold text-black">
              Hi, I'm your new AI-PM model, Iris.
            </h1>
